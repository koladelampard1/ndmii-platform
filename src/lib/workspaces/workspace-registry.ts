...
export const WORKSPACE_REGISTRY: Record<WorkspaceId, WorkspaceDefinition> = {
  ...
  correspondence: defineWorkspace({
    ...
    navigation: [
      ...
      { label: "Correspondence", href: "/dashboard/correspondence/register" },
      { label: "Create", href: "/dashboard/correspondence/create" },
      { label: "My Work", href: "/dashboard/correspondence/my-work" },
    ...
    navigationSections: [
      { label: "Correspondence", items: [
        ...
        { label: "Create Correspondence", href: "/dashboard/correspondence/create" },
        { label: "My Work", href: "/dashboard/correspondence/my-work" },
        { label: "Drafts", href: "/dashboard/correspondence/drafts" },
        { label: "Review", href: "/dashboard/correspondence/review" },
        { label: "Approvals", href: "/dashboard/correspondence/approvals" },
      ] },
      { label: "Issuance", items: [
        { label: "Document Preview", href: "/dashboard/correspondence/preview" },
        { label: "Version History", href: "/dashboard/correspondence/versions" },
        { label: "Signature Queue", href: "/dashboard/correspondence/signatures" },
        { label: "Dispatch Queue", href: "/dashboard/correspondence/dispatch" },
        ...
        { label: "Related", href: "/dashboard/correspondence/related" },
        { label: "Public Verification", href: "/correspondence/verify" },
      ] },
      { label: "Administration", items: [
        { label: "Templates", href: "/dashboard/correspondence/templates" },
        { label: "Contacts", href: "/dashboard/correspondence/contacts" },
        { label: "Delegations", href: "/dashboard/correspondence/delegations" },
        { label: "Reports", href: "/dashboard/correspondence/reports" },
        { label: "Administration", href: "/dashboard/correspondence/administration" },
      ] },
    ],
    ...
    quickActions: [
      { label: "Create outgoing", href: "/dashboard/correspondence/create/outgoing" },
      { label: "Register incoming", href: "/dashboard/correspondence/create/incoming" },
      { label: "Open register", href: "/dashboard/correspondence/register" },
    ],
    dataClassification: [
