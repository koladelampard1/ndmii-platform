...
export const WORKSPACE_REGISTRY: Record<WorkspaceId, WorkspaceDefinition> = {
  boi: {
    ...
    navigation: [
      ...
      { label: "Business Pipeline", href: "/dashboard/boi/business-pipeline", legacyHref: "/dashboard/impact-intelligence/cohorts" },
      ...
      { label: "Investment Readiness", href: "/dashboard/boi/investment-readiness", legacyHref: "/dashboard/impact-intelligence/assessments" },
      { label: "Supporting Documents", href: "/dashboard/boi/documents", legacyHref: "/dashboard/impact-intelligence/evidence" },
      { label: "Portfolio Monitoring", href: "/dashboard/boi/portfolio-monitoring", legacyHref: "/dashboard/impact-intelligence/monitoring" },
      { label: "Portfolio Intelligence", href: "/dashboard/boi/portfolio-intelligence", legacyHref: "/dashboard/impact-intelligence/analytics" },
      { label: "Institutional Reports", href: "/dashboard/boi/reports", legacyHref: "/dashboard/impact-intelligence/reports" },
      { label: "Risk Signals", href: "/dashboard/boi/risk-signals", legacyHref: "/dashboard/impact-intelligence/risk-flags" },
    ],
    terminology: {
    ...
    quickActions: [
      { label: "Review business pipeline", href: "/dashboard/boi/business-pipeline" },
      { label: "Open readiness reviews", href: "/dashboard/boi/investment-readiness" },
      { label: "View institutional reports", href: "/dashboard/boi/reports" },
    ],
  },
  nrs: {
    id: "nrs",
    title: "NRS Revenue Workspace",
    subtitle: "Revenue compliance, VAT monitoring, invoice visibility, and taxpayer intelligence.",
    logoLabel: "NRS",
    icon: "ReceiptText",
    ...
    navigation: [
      { label: "NRS Operations", href: "/dashboard/nrs" },
      { label: "Invoice Registry", href: "/dashboard/nrs/invoices" },
      { label: "VAT Monitor", href: "/dashboard/nrs/vat-monitor" },
      { label: "Revenue Monitor", href: "/dashboard/nrs/revenue" },
      { label: "Revenue Guides", href: "/dashboard/revenue-guides" },
    ],
    terminology: { programme: "Revenue Programme", programmes: "Revenue Programmes", analytics: "Tax Intelligence", reports: "Revenue Reports" },
    quickActions: [
      { label: "Open invoice registry", href: "/dashboard/nrs/invoices" },
      { label: "Review VAT monitor", href: "/dashboard/nrs/vat-monitor" },
    ],
  },
  fccpc: {
    id: "fccpc",
