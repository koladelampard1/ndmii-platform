...
export const ROLE_ROUTE_PREFIXES: Record<Exclude<UserRole, "public">, string[]> = {
  admin: ["/dashboard", "/admin"],
  super_admin: ["/dashboard", "/admin"],
  boi_executive: ["/dashboard/boi", "/dashboard/impact-intelligence"],
  ...
  firs_officer: ["/dashboard/nrs", "/dashboard/firs"],
};
...
export const ROLE_NAV_ITEMS: Record<Exclude<UserRole, "public">, NavigationItem[]> = {
  ...
  boi_executive: [
    { href: "/dashboard/boi", label: "BOI Overview" },
    { href: "/dashboard/boi/business-pipeline", label: "Business Pipeline" },
    { href: "/dashboard/boi/funding-programmes", label: "Funding Programmes" },
    { href: "/dashboard/boi/funding-pipeline", label: "Funding Pipeline" },
    { href: "/dashboard/boi/investment-readiness", label: "Investment Readiness" },
    { href: "/dashboard/boi/documents", label: "Supporting Documents" },
    { href: "/dashboard/boi/portfolio-monitoring", label: "Portfolio Monitoring" },
    { href: "/dashboard/boi/portfolio-intelligence", label: "Portfolio Intelligence" },
    { href: "/dashboard/boi/reports", label: "Institutional Reports" },
    { href: "/dashboard/boi/risk-signals", label: "Risk Signals" },
  ],
  programme_officer: [
    { href: "/dashboard/lcdbo", label: "LCDBO Workspace" },
  ...
  nrs_officer: [
    { href: "/dashboard/nrs", label: "Executive Dashboard" },
    { href: "/dashboard/nrs/businesses", label: "Business Registry" },
    { href: "/dashboard/nrs/readiness", label: "Formalisation & Readiness" },
    { href: "/dashboard/nrs/intelligence", label: "National Intelligence" },
    { href: "/dashboard/nrs/revenue-guides", label: "Revenue Guides" },
    { href: "/dashboard/nrs/programmes", label: "Programmes & Enablement" },
    { href: "/dashboard/nrs/reports", label: "Reports" },
    { href: "/dashboard/nrs/verification", label: "Verification" },
    { href: "/dashboard/nrs/integrations", label: "Integrations" },
    { href: "/verify", label: "Public Verification" },
  ],
  firs_officer: [
    { href: "/dashboard/nrs", label: "Executive Dashboard" },
