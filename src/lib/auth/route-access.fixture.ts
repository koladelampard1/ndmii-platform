...
export const ROUTE_ACCESS_FIXTURE: Record<Exclude<UserRole, "public">, { allowed: string[]; denied: string[] }> = {
  ...
  programme_officer: {
    allowed: ["/dashboard/impact-intelligence", "/dashboard/impact-intelligence/cohorts", "/dashboard/impact-intelligence/interventions"],
    denied: ["/dashboard/msme", "/dashboard/admin"],
  },
  assessment_officer: {
  ...
  field_officer: {
    allowed: ["/dashboard/impact-intelligence/cohorts", "/dashboard/impact-intelligence/monitoring", "/dashboard/impact-intelligence/evidence"],
