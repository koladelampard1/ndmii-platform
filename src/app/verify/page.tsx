    ...
    <main className="min-h-screen bg-slate-100 px-6 py-14">
      <section className="mx-auto max-w-5xl">
        ...
        <section className="mx-auto mt-8 max-w-3xl">
          {!hasSearch && (
            <p className="rounded-xl border border-slate-200 bg-white px-5 py-4 text-center text-sm text-slate-600 shadow-sm">
              Search to view a verification result.
            </p>
          )}

          {hasSearch && results.length === 0 && (
            <p className="rounded-xl border border-amber-200 bg-amber-50 px-5 py-4 text-center text-sm text-amber-900">
