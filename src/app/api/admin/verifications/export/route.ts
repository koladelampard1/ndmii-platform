...
function filterFromUrl(url: URL): AdminVerificationFilters {
  return {
    ...
    missingCriticalDocuments: url.searchParams.get("missingCriticalDocuments") ?? undefined,
    outstandingDocumentRequests: url.searchParams.get("outstandingDocumentRequests") ?? undefined,
    reusedDocumentSignal: url.searchParams.get("reusedDocumentSignal") ?? undefined,
    rejectedDocuments: url.searchParams.get("rejectedDocuments") ?? undefined,
    documentCompletenessBelow50: url.searchParams.get("documentCompletenessBelow50") ?? undefined,
