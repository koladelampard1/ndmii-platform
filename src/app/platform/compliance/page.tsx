...
export const metadata: Metadata = {
  ...
  description: "Explore DBIN compliance readiness, evidence workflows, reminders, VAT exposure indicators and regulator-ready business signals.",
...
export default function CompliancePage() {
  return (
    <PublicPageShell
      ...
      description="DBIN supports compliance evidence, readiness tracking, reminders and governed tax-readiness visibility. It does not claim official tax filing, TIN validation or official VAT remittance."
    ...
    >
      <section className="mt-10 grid gap-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
        <div>
          ...
          <p className="mt-4 text-base leading-7 text-slate-600">
            Compliance workspaces use careful language: readiness, evidence, visibility, regulator workflow and integration-ready signals—not official filing or assessment.
          </p>
        </div>
      ...
      <section className="mt-14 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <CapabilityProofCard title="Compliance centre" text="Track requirements, evidence and readiness status." status="Available" />
        <CapabilityProofCard title="Evidence review" text="Support structured review without exposing public-private records." status="Available" />
        <CapabilityProofCard title="Reminder workflow" text="Help businesses stay ahead of deadlines and renewals." status="Available" />
        <CapabilityProofCard title="Regulator-ready visibility" text="Designed to support governed institutional workflows." status="Platform Capability" />
      </section>
      ...
      <section className="mt-14 rounded-3xl border border-amber-200 bg-amber-50 p-6 text-amber-950">
        ...
        <p className="mt-2 text-sm leading-6">
          DBIN readiness workspaces are not official tax filings, remittance ledgers, TIN validations, VAT assessments or government determinations. They are designed to support better records and governed institutional workflows.
        </p>
