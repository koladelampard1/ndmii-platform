    ...
    <section className="space-y-4">
      ...
      <article className="rounded-xl border bg-white p-4">
        ...
        <ul className="mt-3 grid list-disc gap-2 pl-5 text-sm text-slate-700 md:grid-cols-2">
          <li>Public provider URL: <Link className="font-medium text-indigo-700 hover:underline" href={`/providers/${workspace.provider.slug}`}>/providers/{workspace.provider.slug}</Link></li>
