    ...
    <section className="space-y-6">
      <header className="rounded-2xl border bg-gradient-to-r from-indigo-900 via-slate-900 to-emerald-900 p-7 text-white shadow-xl">
        ...
        <div className="mt-3 flex flex-wrap gap-2 text-xs">
          <Link href="/dashboard/msmes" className="rounded bg-white/15 px-2 py-1 hover:bg-white/25">MSME registry</Link>
          <Link href="/dashboard/verifications" className="rounded bg-white/15 px-2 py-1 hover:bg-white/25">Verification queue</Link>
          <Link href="/dashboard/digital-ids" className="rounded bg-white/15 px-2 py-1 hover:bg-white/25">Digital IDs</Link>
        </div>
      </header>
