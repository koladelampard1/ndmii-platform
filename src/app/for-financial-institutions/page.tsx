...
export default function ForFinancialInstitutionsPage() {
  return (
    <PublicPageShell
      ...
      description="Use DBIN identity and verification records to reduce due-diligence friction, improve customer trust signals, and accelerate MSME enablement workflows."
      primaryCta={{ label: "Partner with DBIN", href: "/partners?segment=financial-institutions" }}
