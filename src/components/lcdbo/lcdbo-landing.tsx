...
function LandingHero() {
  return <section className="relative isolate min-h-[660px] overflow-hidden bg-[#06172f] text-white sm:min-h-[700px]">
    <Image src="/images/lcdbo/factory-operations.jpg" alt="Industrial engineer working with advanced manufacturing machinery" fill priority sizes="100vw" className="object-cover object-[63%_center] scale-[1.02]" />
...
function PartnershipSection() {
  ...
  return <section className="border-t border-slate-200 bg-white px-4 py-16 sm:px-6 lg:py-20"><div className="mx-auto max-w-7xl"><div className="mx-auto max-w-3xl text-center"><p className="text-xs font-black uppercase tracking-[0.18em] text-[#008751]">Institutional credibility</p><h2 className="mt-3 text-4xl font-black tracking-tight text-[#06172f] sm:text-5xl">Built Through Strategic Partnership</h2><p className="mt-4 text-base leading-7 text-slate-600">A national programme framework designed to align public leadership, industrial expertise and long-term capital.</p></div><div className="mt-9 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">{partnerCategories.map((partner) => { const Icon = partner.icon; return <article key={partner.title} className="group flex min-h-28 items-center gap-4 rounded-2xl border border-slate-200 bg-[#f8fafc] p-5 transition duration-300 hover:-translate-y-1 hover:border-[#008751]/30 hover:bg-white hover:shadow-lg"><span className="grid h-12 w-12 shrink-0 place-items-center rounded-2xl border border-emerald-100 bg-emerald-50 text-[#008751] transition duration-300 group-hover:bg-[#008751] group-hover:text-white"><Icon className="h-5 w-5" /></span><div><p className="text-[9px] font-black uppercase tracking-[0.16em] text-slate-400">Partner category</p><h3 className="mt-1 font-black leading-5 text-[#06172f]">{partner.title}</h3></div></article>; })}</div></div></section>;
}

function FinalCta() {
  return <section className="group relative isolate overflow-hidden bg-[#06172f] px-4 py-20 text-white sm:px-6 lg:py-28"><Image src="/images/lcdbo/export-containers.jpg" alt="International container port representing Nigeria's export ambition" fill sizes="100vw" className="object-cover transition duration-[1400ms] group-hover:scale-[1.025]" /><div className="absolute inset-0 bg-[#041226]/78" /><div className="absolute inset-0 bg-gradient-to-r from-[#041226]/98 via-[#041226]/78 to-[#041226]/30" /><div className="relative mx-auto max-w-7xl"><div className="max-w-4xl"><p className="text-xs font-black uppercase tracking-[0.2em] text-[#efc85d]">The future is built together</p><h2 className="mt-4 text-4xl font-black tracking-tight sm:text-6xl lg:text-7xl">Be part of Nigeria&apos;s industrial transformation.</h2><p className="mt-5 text-xl font-bold text-slate-200 sm:text-2xl">Connect. Grow. Transform.</p><div className="mt-6 grid gap-2 text-xs font-black uppercase tracking-[0.14em] text-slate-300 sm:flex sm:flex-wrap sm:gap-x-6"><span>More productive jobs</span><span className="hidden text-[#efc85d] sm:inline">•</span><span>Competitive industry</span><span className="hidden text-[#efc85d] sm:inline">•</span><span>Investment at scale</span></div><div className="mt-8 flex flex-col gap-3 sm:flex-row"><PrimaryLink href={LCDBO_REGISTER_HREF}>Register Your Business</PrimaryLink><SecondaryLink href={LCDBO_PARTNER_HREF}>Partner With LCDBO</SecondaryLink></div></div></div></section>;
}
