...
// methodology, and approval validation before production launch.
...
const deliveryCards: Array<{ title: string; description: string; image: string; alt: string; icon: LucideIcon; credit?: string; creditHref?: string }> = [
  { title: "Industrial Clusters", description: "Shared production infrastructure that turns local capability into industrial-scale output.", image: "/images/lcdbo/industrial-cluster-warehouse.jpg", alt: "Coordinated warehouse operation supporting shared industrial production and distribution", icon: Factory },
  { title: "MSME Enablement", description: "Grow production capacity, strengthen readiness and reach new markets.", image: "/images/lcdbo/nigerian-msme-workshop-production.jpg", alt: "Nigerian woman measuring materials in her production workshop", icon: BriefcaseBusiness, credit: "Akpeski / CC BY-SA 4.0", creditHref: "https://commons.wikimedia.org/wiki/File:Wood_processing_at_the_workshop.jpg" },
  { title: "Investment Flows", description: "Surface investable industrial pipelines and support disciplined capital deployment.", image: "/images/lcdbo/industrial-landscape-cta.jpg", alt: "Industrial infrastructure prepared for strategic investment", icon: Banknote },
  { title: "Exports & Markets", description: "Build export-ready value chains connected to buyers across Africa and global markets.", image: "/images/lcdbo/export-containers.jpg", alt: "Aerial view of a busy container port and export logistics hub", icon: Ship },
];
...
const stakeholders: Array<{ title: string; benefit: string; icon: LucideIcon }> = [
  ...
  { title: "Investors", benefit: "Access visible, investment-ready industrial pipelines.", icon: TrendingUp },
  { title: "States", benefit: "Create jobs, attract investment and expand industrial capacity.", icon: Landmark },
  { title: "Partners", benefit: "Coordinate national delivery and measurable industrial outcomes.", icon: Handshake },
  { title: "Technical Partners", benefit: "Strengthen standards, engineering and production capability.", icon: Wrench },
  { title: "Development Institutions", benefit: "Deploy catalytic capital into traceable, high-impact growth.", icon: Building2 },
];
...
function DeliverySection() {
  return <Section eyebrow="What LCDBO delivers" title="An ecosystem built for industrial scale." description="Connect production capacity, investable infrastructure and market access in one national growth pathway.">
