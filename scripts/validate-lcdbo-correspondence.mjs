...
const correspondenceHomePage = read("src/app/dashboard/correspondence/page.tsx");
...
assert.match(correspondenceHomePage, /Your attention is needed[\s\S]*Ready for dispatch[\s\S]*Start here/, "correspondence home must choose a clear next action from live workflow state");
assert.match(correspondenceHomePage, /A simple two-party process[\s\S]*Current work/, "correspondence home must explain the workflow without restoring dashboard density");
...
assert.match(correspondenceWorkspace, /label: "Needs your action", href: "\/dashboard\/correspondence\/my-work"/, "representative action nav missing");
...
assert.match(correspondenceWorkspace, /label: "All correspondence", href: "\/dashboard\/correspondence\/register"/, "correspondence register nav missing");
assert.match(correspondenceWorkspace, /quickActions: \[\]/, "duplicate correspondence quick actions must remain removed");
